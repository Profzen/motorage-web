...
### Backend (Admin API)
- [ ] **API Signalements** : Finaliser `GET /api/admin/reports` pour lister les litiges.
- [ ] **Résolution** : Endpoint pour marquer un signalement comme `résolu` ou `rejeté`.

### Web Frontend (Admin)
- [ ] **Interface Litiges** : Créer `/dashboard/reports` pour visualiser et traiter les plaintes.
