            ...
            schemas: {
                ...
                Notification: {
                    ...
                    properties: {
                        ...
                        type: { type: 'string', enum: ['onboarding', 'reservation', 'system', 'trajet'] },
                        title: { type: 'string' },
                        message: { type: 'string' },
                        isRead: { type: 'boolean' },
                        data: { type: 'string', description: 'JSON string contextuel', nullable: true },
                ...
                Report: {
                    ...
                    properties: {
                        ...
                        type: { type: 'string', enum: ['comportement', 'retard', 'securite', 'autre'] },
                        titre: { type: 'string' },
                ...
                ApiError: {
                    ...
                    properties: {
                        code: { type: 'string', description: 'Code d\'erreur unique (ex: INVALID_CREDENTIALS)' },
                        message: { type: 'string', description: 'Message d\'erreur lisible' },
                        field: { type: 'string', nullable: true, description: 'Champ concerné (pour les erreurs de validation)' },
                        details: { type: 'object', nullable: true, description: 'Détails supplémentaires' },
                    }
                },
                ErrorResponse400: {
                    type: 'object',
                ...
                PaginationMeta: {
                    ...
                    properties: {
                        ...
                        hasNext: { type: 'boolean', description: 'Existe-t-il une page suivante' },
                        hasPrev: { type: 'boolean', description: 'Existe-t-il une page précédente' },
                    },
                    example: {
                        page: 1,
                        limit: 20,
                ...
                MotoListResponse: {
                    ...
                    properties: {
                        success: { type: 'boolean', example: true },
                        data: { type: 'array', items: { '$ref': '#/components/schemas/Moto' } },
                        error: { type: 'object', nullable: true, example: null },
                        meta: { type: 'object', nullable: true, example: null },
                    }
                },
                ...
                AuthTokens: {
                    ...
                    properties: {
                        token: { type: 'string', description: 'Access token JWT (expire en 15 minutes)' },
                        refreshToken: { type: 'string', description: 'Refresh token JWT (expire en 7 jours)' },
                    }
                },
                LoginResponse: {
                    type: 'object',
                ...
                UploadResponse: {
                    ...
                    properties: {
                        ...
                        data: {
                            type: 'object',
                            properties: {
                                url: { type: 'string', example: '/uploads/2026/01/1737112345678-photo.jpg' },
                ...
                RefreshRequest: {
                    ...
                    properties: {
                        refreshToken: { type: 'string', description: 'Le refresh token à utiliser' }
                    }
                },
                OnboardingRequest: {
                    type: 'object',
                    required: ['permisNumero', 'motoMarque', 'motoModele', 'motoImmatriculation'],
                    properties: {
                ...
                OnboardingRequestRecord: {
                    ...
                    properties: {
                        ...
                        motoModele: { type: 'string' },
                        motoImmatriculation: { type: 'string' },
                        statut: { type: 'string', enum: ['en_attente', 'approuvé', 'rejeté'] },
                        commentaireAdmin: { type: 'string', nullable: true },
                        createdAt: { type: 'string', format: 'date-time' },
                ...
                OnboardingRequestListResponse: {
                    ...
                    properties: {
                        success: { type: 'boolean', example: true },
                        data: { type: 'array', items: { '$ref': '#/components/schemas/OnboardingRequestRecord' } },
                        error: { type: 'object', nullable: true, example: null },
                        meta: { '$ref': '#/components/schemas/PaginationMeta' },
                    }
                }
