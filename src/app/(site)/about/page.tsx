...
export const metadata = {
  ...
  description: "En savoir plus sur Miyi Ðekae, la plateforme d'entraide moto pour les étudiants",
};
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-primary/5 to-transparent">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold">À propos de Miyi Ðekae</h1>
          ...
          <div className="mx-auto max-w-3xl space-y-8">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Miyi Ðekae est né d&apos;un constat simple : beaucoup d&apos;étudiants à l&apos;Université de Lomé utilisent la moto comme moyen de transport quotidien. Malheureusement, une panne ou un souci mécanique peut rapidement devenir un problème majeur.
                </p>
                <p>
                ...
                <p>
                  Aujourd&apos;hui, Miyi Ðekae connecte des centaines d&apos;étudiants et facilite chaque jour l&apos;échange de trajets, de conseils mécaniques et d&apos;outils.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-surface">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            <h2 className="text-3xl font-bold mb-12 text-center">Comment Miyi Ðekae fonctionne</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
